...
{
	//for each element in an array of size, create a second dimension
	//array
	//in each index
...
/*
	For this lab, I chose a grid length of 100. A grid length of 1000
	would
	result in 1m total grid locations making it highly likely for a
	value to be
	the only point in its location. My calculation function is
	reliant on there
	being two separate points to compare, and as such is
	entirely reliant on
	collisions. Thus I chose a size smaller than 1m so that I
	would force
